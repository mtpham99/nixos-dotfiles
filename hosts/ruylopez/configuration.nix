...

{
  imports = [
    ...
    ../../modules/homelab/containers/networking/adguard
    ...
    ../../modules/homelab/containers/observability/grafana
    {
      ...
      in {
        ...
        unbound = {
          ...
          custom-config = ''
            # A Records
            local-data: \"ruylopez.lan A 10.10.129.1\"
            local-data: \"grunfeld.lan A 10.10.129.2\"
            local-data: \"najdorf.lan A 10.10.129.3\"
